// Credit goes to this Codepenner! http://codepen.io/thomcc/pen/jbEdbE
...
function update() {
  if ((ticks++ % 40) === 0) {
    var fw = new Firework(Math.random()*window.innerWidth, Math.random()*window.innerHeight*0.75);
...
function render() {
  ctx.save();
  {
    ...
    ctx.fillStyle = 'rgb(19, 37, 57)'; //Background color
